...
const reasons = [
  'You are one of the most caring and thoughtful guy ever, and i can see it from ur tiniest actions.',
  'Incredibly smart, so witty and clever not just academically but in every WAY.',
  'The way you make even ordinary days feel special, even monotonous becomes exciting and fun when i\'m with you.',
  ...
  'Your hugs and how they genuinely fix everything, and i wanna hug not only when im sad but at my happiest too.',
  ...
  'How hard you work for everything you have (excpet ola notice days hehe)',
  'How hot you are, and how good you are at satisfying me lol >_<',
  'How well our personalities match, its like you complete me',
  'How you always communicate so well and always care for my feelings',
  'Coolest taste in music, movies and everything, so cultured you are',
  'Your love for travel/food and ur v intensive knowledge about it all',
  'How you make me feel safe without even trying',
  'Your back, ur hands, ur face, ur eyes- ur so cute i wanna keep u in a pendant and carry u around with me always',
  'The texts you send to me just to say you miss me or love me, these notifications light my face',
  "How beautifully you play the guitar(im such a sucker for you, my rocksatr)",
